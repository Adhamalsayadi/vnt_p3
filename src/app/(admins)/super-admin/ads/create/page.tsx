...
import { ChevronRight, ArrowLeft, Upload, Circle } from "lucide-react";
        ...
        <main className="flex-1 p-8 overflow-auto">
          <div className="max-w-[800px] mx-auto space-y-8">
            ...
            <div className="flex items-center gap-2 text-[13px] font-medium text-[#999]">
              ...
              <ChevronRight size={14} />
              <span className="text-[#333]">create ad</span>
            </div>
            ...
            <div className="bg-white rounded-[32px] shadow-sm border border-[#F2F4F7] overflow-hidden">
               ...
               <div className="p-10 space-y-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="w-full h-48 bg-[#F9FAFB] border-2 border-dashed border-[#EAECF0] rounded-2xl flex flex-col items-center justify-center gap-3 text-[#999] hover:bg-[#F2F4F7] transition-all cursor-pointer group">
                      <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">
                        <Upload size={20} className="text-[#1D1F24]" />
                      </div>
                      <div className="text-center">
                        <span className="text-[13px] font-bold block">click or drag to upload ad image</span>
                        <span className="text-[11px] font-medium opacity-60">recommended size: 1200x400px</span>
                      </div>
                    </div>
                  </div>
